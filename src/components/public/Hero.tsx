            ...
            <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
                ...
                >
                    <span className="inline-block text-white/70 tracking-[0.3em] uppercase text-xs mb-6 font-medium">
                        Şehrinizin En Prestijli Fotoğraf Stüdyosu
                    </span>
                ...
                >
                    Profesyonel Düğün Fotoğrafçısı olarak, en özel anlarınızı sinematik bir estetikle ölümsüzleştiriyoruz. Her karede bir hikaye, her hikayede sonsuz bir aşk.
                </motion.p>
